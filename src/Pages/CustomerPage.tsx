...
const CustomerPage = () => {
  ...
  const fetchCustomer = async () => {
    ...
    try {
      ...
      if (result) {
        // getCustomerProfile returns a response shape; assert to User
        setCustomer(result as unknown as User);
      }
    } catch (err) {
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-text-primary mt-1 flex items-center space-x-1">
                    ...
                    <span>{profile?.dateOfBirth ? formatDate(profile.dateOfBirth) : "N/A"}</span>
                  </p>
                </div>
                <div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-surface rounded-lg border border-border p-6">
              ...
              <div className="space-y-3">
                ...
                {profile?.createdAt && (
                  <div>
                    <p className="text-xs text-text-secondary">Profile Created</p>
                    <p className="text-sm font-medium text-text-primary mt-1">
